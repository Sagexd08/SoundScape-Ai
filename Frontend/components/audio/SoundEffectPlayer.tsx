...
import { AudioLines, ExternalLink, Volume2, VolumeX, Tag, Download } from 'lucide-react';
          ...
          <div className="flex items-start gap-4 mb-3">
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href={`https://www.y2mate.com/youtube/${getYouTubeId(sound.youtubeUrl)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-500 hover:text-blue-400"
                  title="Download sound (via Y2Mate)"
                >
