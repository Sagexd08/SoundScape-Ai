...
interface BackgroundLayoutProps {
  children: ReactNode;
  variant?: 'purple' | 'blue' | 'indigo' | 'default';
}

export default function VibrantBackgroundLayout({ 
  children, 
  variant = 'default' 
  ...
  const getGradients = () => {
    switch (variant) {
      case 'purple':
        return {
          mainGradient: 'from-black via-purple-950/30 to-black',
      ...
      case 'blue':
        return {
          mainGradient: 'from-black via-blue-950/30 to-black',
      ...
      case 'indigo':
        return {
          mainGradient: 'from-black via-indigo-950/30 to-black',
      ...
      default:
        return {
          mainGradient: 'from-black via-gray-950 to-indigo-950',
          accentColor: 'rgba(99, 102, 241, 0.2)',
          nebulaColors: [
            'bg-indigo-900/10',
            'bg-purple-900/10',
  ...
  const { mainGradient, accentColor, nebulaColors } = getGradients();
  
  return (
    <div className={`min-h-screen bg-gradient-to-b ${mainGradient} text-white relative overflow-hidden`}>
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute w-full h-full overflow-hidden">
          {/* Large nebula glow */}
          <div className={`absolute top-[10%] -left-[10%] w-[70%] h-[60%] rounded-full ${nebulaColors[0]} filter blur-[100px]`}></div>
          <div className={`absolute bottom-[5%] -right-[5%] w-[50%] h-[50%] rounded-full ${nebulaColors[1]} filter blur-[100px]`}></div>
          <div className={`absolute top-[40%] right-[10%] w-[40%] h-[40%] rounded-full ${nebulaColors[2]} filter blur-[80px]`}></div>
        </div>
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(circle at 50% 50%, ${accentColor}, rgba(0, 0, 0, 0.4))`,
