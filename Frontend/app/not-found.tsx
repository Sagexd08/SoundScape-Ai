...
// It uses only static HTML/CSS without any client-side hooks
    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-indigo-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          <div className="max-w-md w-full p-8 bg-black/60 backdrop-blur-md rounded-lg border border-gray-800 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/"
                className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white rounded-md font-medium transition-all duration-200 shadow-lg shadow-indigo-600/20"
              >
                Return Home
              </Link>
              ...
              <Link
                href="/"
                className="px-4 py-2 bg-transparent border border-gray-700 hover:border-gray-500 text-gray-300 hover:text-white rounded-md font-medium transition-all duration-200"
              >
                Go Back
              </Link>
            </div>
